...
export async function metadata(
  ...
  return JsonGet(input, `${scope()}/metadata`);
}

export type size_input = WithClient<{ query: PathQuery }>;
export type size_output = ResponseResult<Size>;
export async function size(input: size_input): Promise<size_output> {
  return JsonGet(input, `${scope()}/size`);
}

export type move_input = WithClient<{ data: SourceDestinationData }>;
export type move_output = ResponseResult<Bytes>;
export async function move(input: move_input): Promise<move_output> {
  return RawPost(input, `${scope()}/move`);
}

export type remove_input = WithClient<{ query: PathQuery }>;
export type remove_output = ResponseResult<Bytes>;
export async function remove(input: remove_input): Promise<remove_output> {
  return RawPost(input, `${scope()}/remove`);
}

export type copy_input = WithClient<{ data: SourceDestinationData }>;
export type copy_output = ResponseResult<Bytes>;
export async function copy(input: copy_input): Promise<copy_output> {
  return RawPost(input, `${scope()}/copy`);
}

export type read_file_input = WithClient<{ query: PathQuery }>;
...
export async function read_file(
  ...
  return RawGet(input, `${scope()}/read_file`);
}

export type write_file_input = WithClient<{ query: PathQuery; data: Bytes }>;
export type write_file_output = ResponseResult<Bytes>;
export async function write_file(
  input: write_file_input
): Promise<write_file_output> {
  return RawPost(input, `${scope()}/write_file`);
}
...
export async function read_folder(
  ...
  return JsonGet(input, `${scope()}/read_folder`);
}

export type create_folder_input = WithClient<{ query: PathQuery }>;
...
export async function create_folder(
  ...
  return RawPost(input, `${scope()}/create_folder`);
}
...
export async function get_permissions(
  ...
  return JsonGet(input, `${scope()}/get_permissions`);
}
...
export async function set_permissions(
  ...
  return RawPost(input, `${scope()}/set_permissions`);
}
